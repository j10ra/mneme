      ...
      <div className="block min-[1024px]:hidden p-8">
        <div className="rounded-lg border border-border bg-card p-6 text-card-foreground">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            This dashboard is desktop-only (≥1024px). On smaller screens, use the slash commands (
            <code>/mneme:status</code>,<code>/mneme:recall</code>, …) or open on a wider screen.
          </p>
        </div>
      </div>
            ...
            <div className="flex flex-1 min-h-0 flex-col overflow-hidden rounded-lg border border-border bg-card">
              <TabsPanel value="activity" className="flex-1 min-h-0">
                <ResizablePanelGroup orientation="horizontal">
                  ...
                  <ResizableHandle />
                  <ResizablePanel id="logs" defaultSize="60%" minSize="280px" maxSize="80%">
                    <LogsPanel />
                  </ResizablePanel>
                </ResizablePanelGroup>
              </TabsPanel>
